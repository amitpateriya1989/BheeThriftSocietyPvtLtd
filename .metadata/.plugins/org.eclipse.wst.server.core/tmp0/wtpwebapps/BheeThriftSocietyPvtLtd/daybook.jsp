...
<%
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->	
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Day Book</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	   </div><!-- end portlet-title -->
	   <div class="portlet-body">
	    <form id="frmDaybook" autocomplete="off" action="AdLedgerAccount?action=daybook" method="post">
			<table class="table table-bordered">
				<tr>
					...
					<td width="35%"><input class="form-control input-medium date-picker" type="text" placeholder="dd/mm/yyyy" name="to" id="to" value="<%=to%>"/>
	...
	<div class="portlet-title">
	<div class="caption">Day Book View</div>
	<div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	</div><!-- end portlet-title -->
	<div class="portlet-body">
	<table class="table table-bordered">
...
$(document).ready(function(e){
	...
	$('#btnShowView').click(function(){
		loading_show();
		if(jQuery("#frmDaybook").valid()==true){
...
var tableToExcel = (function() {
  ...
  return function(table, name) {
    if (!table.nodeType) table = document.getElementById('day_book')
