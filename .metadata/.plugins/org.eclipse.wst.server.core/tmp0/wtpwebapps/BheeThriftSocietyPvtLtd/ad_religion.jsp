...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Religion</a><i class="fa fa-angle-right"></i>Add and view</li>
		</ul>
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Add Religion</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a>
	   </div>
	   </div>
	   <div class="portlet-body">
	    <form id="frmReligion" action="AdReligion?action=insert" method="post" autocomplete="off">
			<table class="table table-bordered">
				<tr>
					<td width="20%">Religion : <span class="red">*</span></td>
					<td width="80%"><input class="form-control input-medium" type="text" name="religion" /><label class="error"></label></td>
				</tr>
				<tr>
					<td></td>
					<td>
	   ...
	   <div class="portlet-body">
			<table id="dataTable1" class="table table-striped table-bordered table-hover">
				...
				<%ReligionDao dao=new ReligionDao();
					ArrayList<ReligionBean> slist=dao.getAllReligion();
					int i=0;
					if(slist!=null){
						for(ReligionBean bean:slist){
				%> 
				 <tr>
				   <td><%=++i %></td>
				   ...
				   <td>
				   <a class="btn btn-xs green" href="AdReligion?action=edit&ad_religion_id=<%=bean.getAd_religion_id()%>">
