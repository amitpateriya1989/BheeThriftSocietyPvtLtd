    ...
    return {
        //main function to initiate the module
            ...
            if($("#ad_pf_id").val().trim()==""){
            	...
            	$('#ad_member_satus_id option[value='+3+']').attr('selected','selected');
            }
                		...
                		success: function(data){
                			if(data.message=="true"){
                				...
                				if(dataId>0){
                					...
                					$('#h_member_name_up').val($('#name').val());
                					$('#show_share_batch').html(data.sharebatchno);
                					$('#show_share_from').html(data.shareformhno);
                					$('#show_share_to').html(data.sharetono);
                					$('#show_trx_no').html(data.Trxno);
                					$('.button-show-modal').show();
