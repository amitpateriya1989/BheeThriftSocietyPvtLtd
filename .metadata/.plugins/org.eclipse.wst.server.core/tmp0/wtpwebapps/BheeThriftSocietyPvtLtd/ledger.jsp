...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Account</a><i class="fa fa-angle-right"></i>Ledger</li>
		</ul>
...
<!------------------------------------------------------------------- -->
	...
	<tr>
	    ...
	    <div class="row">
		<div class="col-md-12">
			<div id="ledger_window" style="height:450px;overflow-y:auto;"></div>
		</div><!-- End column -->
		</div><!-- End row -->
	</div><!-- End portlet-body -->
	</div><!-- En portlet box -->
