...
$(document).ready(function(e){
	var url="getmembershare.jsp";
	$('#share_window').attr('src', url);	
...
<table id="tblContainer" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody><tr>
		...
		<table>
		<tr>
		<%-- <td>FD No</td><td>:</td><td><select id="fdno"><option value="<%=0%>">--select--</option>
		<%
		...
		<td></td><td>:</td><td><input onclick="tableToExcel('share', 'SHARE')" type="button" id="exportex" value="Export In Excel"/></td>
		</tr>
		</table>
		<table width="100%">
		<tr>
		...
		<iframe id="share_window" style="width: 100%; min-height:50vh; border: none" src="">
...
<script type="text/javascript">
    ...
    var divElements = document.getElementById('share_window').contentWindow.document.body.innerHTML;
...
var tableToExcel = (function() {
  ...
  return function(table, name) {
    if (!table.nodeType) table = document.getElementById('share_window').contentDocument.getElementById(table)
