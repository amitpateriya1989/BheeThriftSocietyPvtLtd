...
<table id="tblContainer" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody><tr>
		...
		<td></td><td>:</td><td><input onclick="tableToExcel('currentposition', 'Current Position')" type="button" id="exportex" value="Export In Excel"/></td>
		</tr>
		</table>
		<table width="100%">
		<tr>
