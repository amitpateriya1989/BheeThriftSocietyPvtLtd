						...
						<div class="row">
							<div class="col-md-12">
								<ul class="page-breadcrumb breadcrumb">
									<li><i class="fa fa-home"></i> <a href="#">Share</a><i
										class="fa fa-angle-right"></i></li>
									<li><a href="#">Share Detail</a><i
							...
							<div class="col-md-12">
								...
								<div class="portlet box purple">
									<div class="portlet-title">
										<div class="caption">Share Trx Detail</div>
										<div class="tools">
								...
								<div class="portlet box purple">
									<div class="portlet-title">
										<div class="caption">View Share Detail</div>
										<div class="tools">
											<a href="javascript:;" class="collapse"> </a>
										</div>
									</div>
									...
									<div class="portlet-body">
										<div id="view_share_detail" style="height:450px;overflow-y:auto;">
											<!-- <table id="dataTable1"
		...
		jQuery(function() {
			...
			$('#btnShowView').click(function() {
				...
				if (jQuery("#frmShareDetail").valid() == true) {
					...
					$.ajax({
						type : "POST",
						url : "Ajax/getAllShareDetailByMemberId.jsp",
						data : dataString,
						success : function(data) {
							//alert(data);
							$("#view_share_detail").html(data);
						},
