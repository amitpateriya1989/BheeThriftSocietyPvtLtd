...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Account</a><i class="fa fa-angle-right"></i>PROFIT & LOSS</li>
		</ul>
...
<%
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->	
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">PROFIT & LOSS</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	   </div><!-- end portlet-title -->
	   <div class="portlet-body">
	    <form id="frmProfitLoss" autocomplete="off" action="#" method="post">
	...
	<div class="portlet-title">
	<div class="caption">PROFIT & LOSS View</div>
	<div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	</div><!-- end portlet-title -->
	<div class="portlet-body">
	<table class="table table-bordered">
	<tr>
		<td>
			...
			<li><a href="#" onclick="tableToExcel('profitloss', 'profit&loss')"><img src="Image/excel-icon.png" height="25" width="25" /> Excel</a></li>
...
$(document).ready(function(e){
	...
	$('#btnShowView').click(function(){
		loading_show();
		if(jQuery("#frmProfitLoss").valid()==true){
