...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Final Payment</a><i class="fa fa-angle-right"></i>Final Payment Detail</li>
		</ul>
...
<!------------------------------------------------------------------- -->
	<!-- BEGIN BORDERED TABLE PORTLET-->	
	 <div class="portlet box purple">
	  ...
	  <form id="frmFinalPayDetail" autocomplete="off" action="" method="post">  
	...
	<div class="portlet-title">
	<div class="caption">Final Payment View</div>
	<div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	</div><!-- end portlet-title -->
	<div class="portlet-body">
	<table class="table table-bordered">
...
ArrayList<FinalPayDetailBean> vtb=vtd.getAllFinalPayDetail();
...
jQuery(function() {  
	...
	jQuery("#frmFinalPayDetail").validate({
		  rules: {
			  from_date:{
				  required: true,
				  validDate:true
...
<script type="text/javascript">
 $(document).ready(function(e){
	...
	$('#btnShowLadger').click(function(){
		...
		if(jQuery("#frmFinalPayDetail").valid()==true){
		...
		$.ajax({
			type:"POST",
			url:"Ajax/getFinalPaymentDetail.jsp",
			data:dataString,
