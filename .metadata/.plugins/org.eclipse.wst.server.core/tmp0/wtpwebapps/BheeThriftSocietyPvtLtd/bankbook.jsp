...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Account</a><i class="fa fa-angle-right"></i>Bank Book</li>
		</ul>
...
<%
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->	
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Bank Book</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	   </div><!-- end portlet-title -->
	   <div class="portlet-body">
	    <form id="frmBankbook" autocomplete="off" action="AdAccountSubGroup?action=insert" method="post">
			<table class="table table-bordered">
				<tr>
					<td width="15%">From Date: : <span class="red">*</span></td>
					<td width="35%"> <input class="form-control input-medium date-picker" placeholder="dd/mm/yyyy" type="text" name="from" id="from" value="<%=from%>" />
					<label id="form_type_error" class="error "></label>
					</td>
					<td width="15%">To Date : <span class="red">*</span></td>
					<td width="35%"><input class="form-control input-medium date-picker" placeholder="dd/mm/yyyy" type="text" name="to" id="to" value="<%=to%>"/>
	...
	<div class="portlet-title">
	<div class="caption">Bank Book View</div>
	<div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	</div><!-- end portlet-title -->
	<div class="portlet-body">
	<table class="table table-bordered">
	<tr>
		<td>
			...
			<li><a href="#" onclick="tableToExcel('bank_book', 'Bank Book')"><img src="Image/excel-icon.png" height="25" width="25" /> Excel</a></li>
	    ...
	    <div class="row">
		<div class="col-md-12">
		<table class="table table-bordered" id="bank_book" name="bank_book">
			<tr><td><div id="balance_window" style="height:450px;overflow-y:auto;"></div></td></tr>
		</table>
		</div><!-- End column -->
		</div><!-- End row -->
	</div><!-- End portlet-body -->
...
$(document).ready(function(e){
	...
	$('#btnShowView').click(function(){
		loading_show();
		if(jQuery("#frmBankbook").valid()==true){
...
<script type="text/javascript">
    ...
    var divElements = document.getElementById('balance_window').innerHTML;
