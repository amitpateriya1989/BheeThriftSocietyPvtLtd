...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Category</a><i class="fa fa-angle-right"></i>Add and view</li>
		</ul>
	 ...
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   ...
	   <div class="portlet-body">
	    <form id="frmCategory" action="AdCategory?action=insert" method="post" autocomplete="off">
			<table class="table table-bordered">
				<tr>
					<td width="20%">Category Name : <span class="red">*</span></td>
					<td width="80%"><input class="form-control input-medium" type="text" name="category" /><label class="error"></label>
					</td>
				</tr>
				<tr>
					<td></td>
	   ...
	   <div class="portlet-body">
			<table id="dataTable1" class="table table-striped table-bordered table-hover">
				...
				<%CategoryDao dao=new CategoryDao();
					ArrayList<CategoryBean> slist=dao.getAllCategory();
					int i=0;
					if(slist!=null){
						for(CategoryBean bean:slist){
				%> 
				 <tr>
				   <td><%=++i %></td>
				   ...
				   <td>
				   <a class="btn btn-xs green" href="AdCategory?action=edit&ad_category_id=<%=bean.getAd_category_id()%>">
