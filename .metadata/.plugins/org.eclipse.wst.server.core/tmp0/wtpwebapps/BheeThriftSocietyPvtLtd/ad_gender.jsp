...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Gender</a><i class="fa fa-angle-right"></i>Add and view</li>
		</ul>
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Add Gender</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a>
	   </div>
	   </div>
	   <div class="portlet-body">
	    <form id="frmGender" action="AdGender?action=insert" method="post" autocomplete="off">
			<table class="table table-bordered">
				<tr>
					<td width="20%">Gender: <span class="red">*</span></td>
					<td width="80%"><input class="form-control input-medium" type="text" name="gender" /><label class="error"></label>
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<%GenderDao dao=new GenderDao();
				 ...
				 <tr>
				   <td><%=++i %></td>
					...
					<td>
						<a class="btn btn-xs green" href="AdGender?action=edit&ad_gender_id=<%=bean.getAd_gender_id()%>">
