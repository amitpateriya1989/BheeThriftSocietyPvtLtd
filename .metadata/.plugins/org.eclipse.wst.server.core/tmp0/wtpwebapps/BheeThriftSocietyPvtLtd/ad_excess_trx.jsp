...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Excess</a><i class="fa fa-angle-right"></i>Add</li>
		</ul>
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Add Excess</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a>
	   </div>
	   </div>
	   <div class="portlet-body">
	    <form id="frmExcess" action="AdExcess?action=insert" method="post" autocomplete="off">
			<table class="table table-bordered">
				...
				<tr>
					...
					<td><input class="form-control input-medium" type="text" name="excess_amt" id="excess_amt" value="0.0" /><label class="error"></label></td>
