...
for(MenuBean menu1:list1){
  ...
  if(sublist.isEmpty()!=true){
      ...
      out.write("\t\t\t\t<a href=\"#\">Home</a><i class=\"fa fa-angle-right\"></i>\r\n");
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t</ul>\r\n");
...
if(V_Trx_No==null){
	V_Trx_No = "";
      ...
      out.write("\r\n");
      out.write("<input type=\"hidden\" name=\"V_Trx_No\" id=\"V_Trx_No\" value=\"");
      out.print(V_Trx_No);
      out.write("\" /><!-- for display message after submit -->\r\n");
      out.write("</div>\r\n");
      out.write("<!------------------------------------------------------------------- -->\r\n");
      ...
      out.write("\r\n");
      out.write("\t<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\"></button>\r\n");
      out.write("\t<strong>Welcome!</strong> Your most welcome in ");
      out.print(clientbean3.getName() );
      out.write(" .\r\n");
      out.write("</div>\r\n");
      out.write("<!------------------------------------------------------------------- -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"visual\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-signal\"></i>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"details\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"number\">\r\n");
      out.write("\t\t\t\t\t\t\t\t +89%\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("$(function(){\r\n");
      out.write("\tvar V_Trx_No = $(\"#V_Trx_No\").val();\r\n");
      out.write("\t\r\n");
      out.write("\tif(V_Trx_No.trim()!=\"\"){\r\n");
      out.write("\t\t$('.custom-messageBox').modal('show');\r\n");
      out.write("\t\t$('#custom-page-message').html(\"Transaction number is \"+V_Trx_No);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("</script> \r\n");
