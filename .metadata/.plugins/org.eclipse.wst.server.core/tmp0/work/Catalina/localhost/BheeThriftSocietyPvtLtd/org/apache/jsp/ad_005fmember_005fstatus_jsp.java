...
public final class ad_005fmember_005fstatus_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    _jspx_dependants = new java.util.ArrayList<java.lang.String>(8);
    _jspx_dependants.add("/validation.html");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(\".charecter\").keypress(function(e){\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("        alert('Please Enter Alphabate and .');\r\n");
      out.write("        return false;\r\n");
      out.write("        }\r\n");
      out.write("\t});\r\n");
      out.write("$(\".alpha\").keypress(function(e){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar regex = new RegExp(\"^[a-zA-Z ]+$\");\r\n");
      out.write("        var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);\r\n");
      out.write("        if (regex.test(str)) {\r\n");
      ...
      out.write("        {\r\n");
      out.write("        e.preventDefault();\r\n");
      out.write("        alert('Please Enter Alphabate');\r\n");
      out.write("        return false;\r\n");
      out.write("        }\r\n");
      out.write("\t});\r\n");
      out.write("$(\".alphanumeric\").keypress(function(e){\r\n");
      out.write("\t\r\n");
      ...
      out.write("    {\r\n");
      out.write("    e.preventDefault();\r\n");
      out.write("    alert('Please Enter Alphabate And Number');\r\n");
      out.write("    return false;\r\n");
      out.write("    }\r\n");
      out.write("});\r\n");
      out.write("\t$(\".zipcode\").keypress(function(e){\t\t\r\n");
      out.write("\t\t var zip = $(this).val();\r\n");
      out.write("\t\t if ((zip.length)>5){\r\n");
      out.write("\t\t\t e.preventDefault();\r\n");
      out.write("\t\t     alert(\"zipcode should only be 6 digits\");\r\n");
      out.write("\t\t     return false;\r\n");
      out.write("\t\t}\t\r\n");
      ...
      out.write("\t     }\t\r\n");
      out.write("\t});\r\n");
      out.write("\t$(\".number\").keypress(function(e){\r\n");
      out.write("\t\t var regex = new RegExp(\"^[0-9]+$\");\r\n");
      out.write("\t     var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);\r\n");
      out.write("\t     if (regex.test(str)) {\r\n");
      out.write("\t         return true;\r\n");
      ...
      out.write("\t     }\r\n");
      out.write("\t});\r\n");
      out.write("\t$(\".amt\").keypress(function(e){\r\n");
      out.write("\t\t var regex = new RegExp(\"^[0-9.]+$\");\r\n");
      out.write("\t     var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);\r\n");
      out.write("\t     if (regex.test(str)) {\r\n");
      out.write("\t         return true;\r\n");
      ...
      out.write("\t     }\r\n");
      out.write("\t});\r\n");
      out.write("\t$(\".amt\").focusout(function(e){\r\n");
      out.write("\t\t var regex = /^\\d+(\\.\\d{1,2})?$/;\r\n");
      out.write("\t     var str = $(\".amt\").val();\r\n");
      out.write("\t     if (regex.test(str)) {\r\n");
      out.write("\t         return true;\r\n");
      out.write("\t     }\r\n");
      out.write("\t     else\r\n");
      ...
      out.write("\t     }\r\n");
      out.write("\t});\r\n");
      out.write("$(\".address\").keypress(function(e){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar regex = new RegExp(\"^[a-zA-Z. 0-9/()]+$\");\r\n");
      out.write("        var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);\r\n");
      out.write("        if (regex.test(str)) {\r\n");
      out.write("            return true;\r\n");
      out.write("        }\r\n");
      ...
      out.write("        }\r\n");
      out.write("\t});\r\n");
      out.write("$(\".panno\").keypress(function(e){\r\n");
      out.write("\t\r\n");
      out.write("\tvar regex = new RegExp(\"^[A-Z0-9]+$\");\r\n");
      out.write("    var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);\r\n");
      out.write("    if (regex.test(str)) {\r\n");
      out.write("        return true;\r\n");
      out.write("    }\r\n");
      ...
      out.write("    {\r\n");
      out.write("    e.preventDefault();\r\n");
      out.write("    alert('Please Enter Number And Capital Latter Only');\r\n");
      out.write("    return false;\r\n");
      out.write("    }\r\n");
      out.write("});\r\n");
      out.write("$(\".panno\").focusout(function(e){\r\n");
      out.write("\t\r\n");
      out.write("\tvar regex = /^[A-Z0-9]{10}$/;\r\n");
      out.write("    var str = $(\".panno\").val();\r\n");
      out.write("    if (regex.test(str)) {\r\n");
      out.write("        return true;\r\n");
      out.write("    }\r\n");
      out.write("    else\r\n");
      out.write("    {\r\n");
      out.write("    e.preventDefault();\r\n");
      out.write("    alert('Please Enter Correct Pan No');\r\n");
      out.write("    return false;\r\n");
      out.write("    }\r\n");
      out.write("});\r\n");
      out.write("\t$(\".ifsc\").focusout(function(e){\r\n");
      out.write("\t\t var regex = /[A-Z|a-z]{4}[0][\\d]{6}$/;\r\n");
      out.write("\t     var str = $(\".ifsc\").val();\r\n");
      out.write("\t     if (regex.test(str)) {\r\n");
      out.write("\t         return true;\r\n");
      out.write("\t     }\r\n");
      out.write("\t     else\r\n");
      ...
      out.write("\t     e.preventDefault();\r\n");
      out.write("\t     $(\".ifsc\").val('');\r\n");
      out.write("\t     alert('Please Enter correct ifsc ');\r\n");
      out.write("\t     return false;\r\n");
      out.write("\t     }\r\n");
      out.write("\t});\r\n");
      out.write("\t$(\".addharno\").focusout(function(e){\r\n");
      out.write("\t\t var regex = /^\\d{4}\\s\\d{4}\\s\\d{4}$/;\r\n");
      out.write("\t     var str = $(\".addharno\").val();\r\n");
      out.write("\t     if (regex.test(str)) {\r\n");
      out.write("\t         return true;\r\n");
      out.write("\t     }\r\n");
      out.write("\t     else\r\n");
      out.write("\t     {\r\n");
      out.write("\t     e.preventDefault();\r\n");
      out.write("\t     $(\".addharno\").val('');\r\n");
      out.write("\t     alert('Please Enter correct Addhar No ');\r\n");
      out.write("\t     return false;\r\n");
      out.write("\t     }\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t$(\".email\").focusout(function(e){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t var regex =/^[\\w\\-\\.\\+]+\\@[a-zA-Z0-9\\.\\-]+\\.[a-zA-z0-9]{2,4}$/;\r\n");
      out.write("\t     var str = $(\".email\").val();\r\n");
      out.write("\t     if (regex.test(str)) {\r\n");
      out.write("\t         return true;\r\n");
      out.write("\t     }\r\n");
      out.write("\t     else\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t$(\".phone\").focusout(function(e){\r\n");
      out.write("\t\t///^\\(?([0-9]{3})\\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/;  \r\n");
      out.write("\t\t var regex =/^\\(?([0-9]{3})\\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/;  \r\n");
      out.write("\t     var str = $(\".phone\").val();\r\n");
      out.write("\t     if (regex.test(str)) {\r\n");
      out.write("\t         return true;\r\n");
      out.write("\t     }\r\n");
      out.write("\t     else\r\n");
      out.write("\t     {\r\n");
      out.write("\t     e.preventDefault();\r\n");
      out.write("\t     alert('Please Enter correct phone No ');\r\n");
      out.write("\t     $(\".phone\").val('');\r\n");
      out.write("\t     return false;\r\n");
      out.write("\t     }\r\n");
      out.write("\t})\r\n");
...
for(MenuBean menu1:list1){
  ...
  if(sublist.isEmpty()!=true){
      ...
      out.write("\t\t\t</li>\r\n");
      out.write("\t\t\t<li><a href=\"#\">Member Status</a><i class=\"fa fa-angle-right\"></i>Add and view</li>\r\n");
      out.write("\t\t</ul>\r\n");
...
if(AppMessage[1].isEmpty()!=true && AppMessage[1].equals("welcome")!=true){ 
      ...
      out.write("\t   <div class=\"caption\">Add Member Status</div>\r\n");
      out.write("\t   <div class=\"tools\"> <a href=\"javascript:;\" class=\"collapse\"> </a>\r\n");
      out.write("\t   </div>\r\n");
      out.write("\t   </div>\r\n");
      out.write("\t   <div class=\"portlet-body\">\r\n");
      out.write("\t    <form id=\"frmMemberStatus\" action=\"AdMemberStatus?action=insert\" method=\"post\" autocomplete=\"off\">\r\n");
      out.write("\t\t\t<table class=\"table table-bordered\">\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td width=\"20%\">MemberStatus : <span class=\"red\">*</span></td>\r\n");
      out.write("\t\t\t\t\t<td width=\"80%\"><input class=\"form-control input-medium\" type=\"text\" name=\"member_status\" /><label class=\"error\"></label>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t  <input class=\"btn blue\" type=\"submit\" name=\"Submit\" value=\"submit\"/>\r\n");
      out.write("\t\t\t\t\t  <input class=\"btn green\" type=\"reset\" name=\"Clear\"/>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t </form>\t\r\n");
      ...
      out.write("\t\tView Member Status\r\n");
      out.write("\t   </div>\r\n");
      out.write("\t   <div class=\"tools\"> <a href=\"javascript:;\" class=\"collapse\"> </a>\r\n");
      out.write("\t   </div>\r\n");
      out.write("\t   </div>\r\n");
      out.write("\t   <div class=\"portlet-body\">\r\n");
      out.write("\t\t\t<table id=\"dataTable1\" class=\"table table-striped table-bordered table-hover\">\r\n");
      out.write("\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th id=\"\">Sno.</th>\r\n");
      out.write("\t\t\t\t\t<th id=\"\">Member Status</th>\r\n");
      out.write("\t\t\t\t\t<th id=\"\">Is Active</th>\r\n");
      out.write("\t\t\t\t\t<th id=\"\">Action</th>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t");
MemberStatusDao dao=new MemberStatusDao();
					ArrayList<MemberStatusBean> slist=dao.getAllMemberStatus();
					int i=0;
					if(slist!=null){
						for(MemberStatusBean bean:slist){
 ...
 if(bean.isIsactive()==true){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<span class=\"badge badge-primary\">Active</span>\r\n");
      out.write("\t\t\t\t\t\t");
 }else{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<span class=\"badge badge-warning\">Inactive</span>\r\n");
      out.write("\t\t\t\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t   <td>\r\n");
      out.write("\t\t\t\t   <a class=\"btn btn-xs green\" href=\"AdMemberStatus?action=edit&ad_member_status_id=");
      out.print(bean.getAd_member_status_id());
      out.write("\">\r\n");
      out.write("\t\t\t\t  <i class=\"fa fa-edit\"></i> edit</a>\r\n");
      out.write("\t\t\t\t  \r\n");
      out.write("\t\t\t\t   </td>\r\n");
      out.write("\t\t\t\t </tr>\r\n");
      out.write("\t\t\t\t ");
      ...
      out.write("\tjQuery('#dataTable1').DataTable();\r\n");
      out.write("\t\r\n");
      out.write("\tjQuery.validator.addMethod(\"alphanumspace\", function(value, element) {\r\n");
      out.write("\t\t  return this.optional(element) || /^[a-zA-Z\\s]*$/.test(value);\r\n");
      out.write("\t\t}, \"Please enter character and space only.\");\r\n");
      out.write("\t\r\n");
      out.write("\tjQuery( \"#frmMemberStatus\" ).validate({\r\n");
      out.write("\t\t  rules: {\r\n");
      out.write("\t\t\t  member_status: {\r\n");
      out.write("\t\t      required: true,\r\n");
      out.write("\t\t      alphanumspace:true,\r\n");
