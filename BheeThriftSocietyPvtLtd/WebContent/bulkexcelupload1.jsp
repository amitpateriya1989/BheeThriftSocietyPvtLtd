...
try{
	int i=0;
  ArrayList<PayrollTempView> payroll=new PayrollTempDao().getAllTempPayrollViewByBatchNo(batch_no,3000,3400);
...
if(payroll.isEmpty()!=true){
	...
	for(PayrollTempView temp:payroll){
								 ...
								 <%
								 grand_total+=thrift+dcf+loan+festival+guesthouse+excess;
                                   } 
	...
	<table class="table table-striped table-bordered table-hover">
				...
				<tr>
					 <td>   Excess </td>
				     <td><input id="excess_amt_other" name="excess_amt_other" class="form-control input-medium " value="0"> </td>
				     <td>Narration</td>
				     <td><input  class="form-control input-medium " id="excess_amt_narration"  name="excess_amt_narration" ></td>
