...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Account</a><i class="fa fa-angle-right"></i>Cashbook</li>
		</ul>
...
<%
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->	
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Cashbook</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	   </div><!-- end portlet-title -->
	   <div class="portlet-body">
	    <form id="frmCashbook" autocomplete="off" action="" method="post">
			<table class="table table-bordered">
				<tr>
					<td width="15%">From Date: : <span class="red">*</span></td>
					<td width="35%"> <input class="form-control input-medium date-picker" placeholder="dd/mm/yyyy" type="text" name="from_date" id="from_date" value="<%=from%>" />
					<label id="form_type_error" class="error "></label>
					</td>
					<td width="15%">To Date : <span class="red">*</span></td>
					<td width="35%"><input class="form-control input-medium date-picker" placeholder="dd/mm/yyyy" type="text" name="to_date" id="to_date" value="<%=to%>"/>
	...
	<div class="portlet-title">
	<div class="caption">Cashbook View</div>
	<div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	</div><!-- end portlet-title -->
	<div class="portlet-body">
	<table class="table table-bordered">
	<tr>
		<td>
			...
			<li><a href="#" onclick="tableToExcel('cash_book', 'Cash Book')"><img src="Image/excel-icon.png" height="25" width="25" /> Excel</a></li>
	    ...
	    <div class="row">
		<div class="col-md-12">
			<div id="balance_window" style="height:450px;overflow-y:auto;"></div>
		</div><!-- End column -->
		</div><!-- End row -->
	</div><!-- End portlet-body -->
	</div><!-- En portlet box -->
...
$(document).ready(function(e){
	...
	$('#btnShowView').click(function(){
		loading_show();
		if(jQuery("#frmCashbook").valid()==true){
...
var tableToExcel = (function() {
  ...
  return function(table, name) {
    if (!table.nodeType) table = document.getElementById('cash_book')
