...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Member</a><i class="fa fa-angle-right"></i>Detail Search</li>
		</ul>
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Search Member Detail</div>
	   ...
	   <form id="frmSearchDetail" name="frmPostingDetail" action="#">
			<table class="table table-bordered">
				<tr>
					<td width="15%">Start Date : <span class="red">*</span></td>
				    <td width="35%">
				    <input class="form-control input-medium date-picker" type="text" name="fdate" id="fdate" value="<%=from %>" />
				    <label class="error"></label>
				    </td>	
				    <td width="15%">End Date : <span class="red">*</span></td>
				    <td width="35%">
				    <input class="form-control input-medium date-picker" type="text" name="tdate" id="tdate" value="<%=to %>" />
				    <label class="error"></label>
				    </td>			
				</tr>
				 <tr>
					<td width="15%">Member Society No. : </td>
					<td colspan="3"> <select class="form-control input-medium"  name="memberno" id="memberno" >
					...
					if(list.isEmpty()!=true){
						for(MemberRegistrationBean bean:list){
							%>
							<option value="M<%=bean.getAd_society_no()%>">M<%=bean.getAd_society_no() %>|<%=bean.getName() %></option>
...
jQuery(function() {       
	...
	if($("#frmSearchDetail").valid()==false){
		...
		var member_no = $('#memberno').val().trim();
