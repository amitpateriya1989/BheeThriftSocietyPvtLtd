...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Account</a><i class="fa fa-angle-right"></i>Loan Type Add and view</li>
		</ul>
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Add Loan Type</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a>
	   </div>
	   </div>
	   <div class="portlet-body">
	    <form id="frmLoanType" action="AdTypeOfLoan?action=insert" method="post" autocomplete="off">
			<table class="table table-bordered">
				<tr>
					<td width="20%">Loan Type : <span class="red">*</span></td>
	   ...
	   <div class="portlet-body">
			<table id="dataTable1" class="table table-striped table-bordered table-hover">
				...
				<%TypeOfLoanDao dao=new TypeOfLoanDao();
					ArrayList<TypeOfLoanBean> slist=dao.getAlltypeofloan();
					int i=0;
					if(slist!=null){
					  for(TypeOfLoanBean bean:slist){
				%>
				 <tr>
				   <td><%=++i %></td>
				   <td><%=bean.getName() %></td>
				   ...
				   <td>
				   <a class="btn btn-xs green" href="AdTypeOfLoan?action=edit&ad_type_of_loan_id=<%=bean.getAd_type_of_loan_id()%>">
