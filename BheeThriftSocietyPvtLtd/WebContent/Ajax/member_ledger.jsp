...
ArrayList<LedgerAccountBean> llist = new LedgerAccountDao().getAllMemberLedgerAccount();
...
%>
<table id="ledger" name="ledger" class="table table-striped table-bordered table-hover" style="font-size: 14px;font-weight: bold;">
<thead>
<tr>
<td>Account :</td><td></td>
</tr>
...
for(LedgerAccountBean lbean:llist){
if(lbean.getAd_ac_type_id()==1 || lbean.getAd_ac_type_id()==2){
TransactionBean opentrxbean =new TransactionDao().getAllLedgerTransactionBefourFromDate(lbean.getAd_account_id(), from, ad_member_id);
...
ArrayList<TransactionBean> vtb=new TransactionDao().getAllLedgerTransactionByFromToDate(lbean.getAd_account_id(), from, to,ad_member_id );
int i=0;
