...
<td>
<table id="day_book" name="day_book" class="table table-striped table-bordered table-hover">
...
%>
			...
			<td ><%=b.getAc_no() %></td>
			<td ><%=b.getAc_name() %></td>
			<td><%if(b.getMember_name()!=null){out.println(b.getAd_society_no()+ " | "+ b.getMember_name());} %></td>
			<td ><%=b.getVtype() %></td>
