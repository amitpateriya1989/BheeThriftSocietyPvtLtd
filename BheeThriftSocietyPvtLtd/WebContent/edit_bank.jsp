...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Bank</a><i class="fa fa-angle-right"></i>Edit</li>
		</ul>
...
<!------------------------------------------------------------------- -->
	...
	<%
	int ad_bank_id=0;
	if(request.getParameter("ad_bank_id")!=null){
		try{
	...
	BankBean bean=dao.getBankById(ad_bank_id);
	if(bean!=null){
	%>		
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Edit Bank</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a>
	   </div>
	   </div>
	   <div class="portlet-body">
	    <form id="frmBank" autocomplete="off" action="AdBank?action=update&ad_bank_id=<%=bean.getAd_bank_id() %>" method="post">
			<table class="table table-bordered">
				<tr>
					<td width="15%">Bank Name : <span class="red">*</span></td>
					<td width="35%">
					<input class="form-control input-medium" type="text" name="bank" value="<%=bean.getBank()%>"/>
				...
				<tr>
					...
					<td colspan="3">
					  ...
					  <a class="btn btn purple" href="ad_bank.jsp">Back</a>
					</td>
				</tr>
			</table>
		 </form>	
