...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Account</a><i class="fa fa-angle-right"></i>Member Ledger
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->	
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Member Ledger</div>
...
$(document).ready(function(e){
	...
	$('#btnShowLadger').click(function(){
		...
		//alert(ad_member_id);
		//alert(ad_account_id);
		var dataString = {'from':from,'to':to,'ad_member_id':ad_member_id};
		
		$.ajax({
			type:"POST",
			url:"Ajax/member_ledger.jsp",
			data:dataString,
