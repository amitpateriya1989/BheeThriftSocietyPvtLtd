...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Relation</a><i class="fa fa-angle-right"></i>Edit</li>
		</ul>
...
<!------------------------------------------------------------------- -->
	...
	if(id!=null){
		try{
		int ad_relation_id=Integer.parseInt(id);
		bean=new RelationDao().getRelationById(ad_relation_id);
	...
	%>	
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Edit Relation</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a>
	   </div>
	   </div>
	   <div class="portlet-body">
	    <form id="frmSalutation" autocomplete="off" action="AdRelation?action=update&ad_relation_id=<%=bean.getAd_relation_id()%>" method="post">
			<table class="table table-bordered">
				<tr>
					<td width="15%">Relation : <span class="red">*</span></td>
					<td width="35%"><input class="form-control input-medium" type="text" name="relation" value="<%=bean.getRelation() %>" /><label class="error"></label>
					</td>
				...
				<tr>
					...
					<td colspan="3">
					  ...
					  <a class="btn purple" href="ad_relation.jsp">Back</a>
					</td>
				</tr>
			</table>
		 </form>	
