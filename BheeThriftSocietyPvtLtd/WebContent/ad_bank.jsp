...
<div class="row light bg-grey">
	...
	<div class="col-md-5">
	<div class="top-user-lbl">Welcome: Mr.  <i class="fa fa-user"></i></div>
	</div>
</div>
</div>
<!-- BEGIN HEADER -->
...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Bank</a><i class="fa fa-angle-right"></i>Add and view</li>
		</ul>
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">Add Bank</div>
	   ...
	   <div class="portlet-body">
	    <form id="frmBank" action="AdBank?action=insert" method="post" autocomplete="off">
			<table class="table table-bordered">
				<tr>
					<td width="20%">Bank Name : <span class="red">*</span></td>
					<td width="80%"><input id="txtName" type="text" name="bank" class="form-control input-medium" /><label class="error"></label>
					</td>
				</tr>
				<tr>
					<td></td>
	   ...
	   <div class="portlet-body">
			<table id="dataTable1" class="table table-striped table-bordered table-hover">
				...
				<%BankDao dao=new BankDao();
					ArrayList<BankBean> slist=dao.getAllBank();
					int i=0;
					if(slist.isEmpty()!=true){
						for(BankBean bean:slist){
				...
				%> 
				 <tr>
				   ...
				   <td><% if(bean.isIsactive()==true){ %>
						...
						<%} %>
				   <td>
				   <a class="btn btn-xs green" href="AdBank?action=edit&ad_bank_id=<%=bean.getAd_bank_id()%>">
