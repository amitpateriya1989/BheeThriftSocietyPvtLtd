...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Account</a><i class="fa fa-angle-right"></i>TRIAL BALANCE</li>
		</ul>
...
<%
	...
	<!-- BEGIN BORDERED TABLE PORTLET-->	
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   <div class="caption">TRIAL BALANCEk</div>
	   <div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	   </div><!-- end portlet-title -->
	   <div class="portlet-body">
	    <form id="frmTrailBalance" autocomplete="off" action="#" method="post">
			<table class="table table-bordered">
				<tr>
					...
					<td width="35%"><input class="form-control input-medium date-picker" type="text" placeholder="dd/mm/yyyy" name="dateto" id="dateto" value="<%=to%>"/>
	...
	<div class="portlet-title">
	<div class="caption">TRIAL BALANCE View</div>
	<div class="tools"> <a href="javascript:;" class="collapse"> </a></div>
	</div><!-- end portlet-title -->
	<div class="portlet-body">
	<table class="table table-bordered">
	<tr>
		<td>
			...
			<li><a href="#" onclick="tableToExcel('trial_balance', 'Trial Balance')"><img src="Image/excel-icon.png" height="25" width="25" /> Excel</a></li>
	    ...
	    <div class="row">
		<div class="col-md-12">
			<div id="trail_balance_window" style="height:450px;overflow-y:auto;"></div>
		</div><!-- End column -->
		</div><!-- End row -->
	</div><!-- End portlet-body -->
	</div><!-- En portlet box -->
...
jQuery(function() {  
	...
	jQuery( "#frmTrailBalance" ).validate({
		  rules: {
			  datefrom:{
				  required: true,
				  //validDate:true
...
$(document).ready(function(e){
	...
	$('#btnShowView').click(function(){
		loading_show();
		if(jQuery("#frmTrailBalance").valid()==true){
		...
		var dataString = {'fdate':fdate,'tdate':tdate};
		 ...
		 $.ajax({
			type:"POST",
			url:"getTrailBalance.jsp",
			data:dataString,
			success: function(data){
				$('#trail_balance_window').html(data);
				loading_hide();
			},
...
<script type="text/javascript">
    ...
    var divElements = document.getElementById('trail_balance_window').innerHTML;
