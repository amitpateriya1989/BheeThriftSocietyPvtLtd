...
<div class="row">
	<div class="col-md-12">
		<ul class="page-breadcrumb breadcrumb">
			...
			<li><a href="#">Account</a><i class="fa fa-angle-right"></i>Loan Category Edit</li>
		</ul>
...
<!------------------------------------------------------------------- -->
	...
	<%
	String category_id=request.getParameter("ad_loan_category_id");
	int ad_loan_category_id=0;
	if(category_id!=null){
		
		try{
			ad_loan_category_id=Integer.parseInt(category_id);
		}catch(NumberFormatException n){
			n.printStackTrace();
		}
		
		LoanCategoryDao gdao=new LoanCategoryDao();
		LoanCategoryBean gbean=gdao.getLoanCategoryById(ad_loan_category_id);
		if(gbean!=null){
	 ...
	 <div class="portlet box purple">
	  <div class="portlet-title">
	   ...
	   <div class="portlet-body">
	    <form id="frmLoanCategory" autocomplete="off" action="AdLoanCategory?action=update&ad_loan_category_id=<%=gbean.getAd_loan_category_id()%>" method="post">
			<table class="table table-bordered">
				...
				<tr>
					...
					<td colspan="3">
					  ...
					  <a class="btn btn purple" href="ad_loan_category.jsp">Back</a>
					</td>
				</tr>
			</table>
		 </form>	
