	  ...
	  <div class="portlet-title">
	   ...
	   <!-- ------------------- -------------- Start Tab ---------------------------------------------->
		<ul class="nav nav-pills">
			<li class="active"><a href="#tab1" data-toggle="tab">New Loan & Deposit</a></li>
       ...
       SimpleDateFormat sdf=new SimpleDateFormat("dd/MM/yyyy");
        ...
        %>
            <tr>
                ...
                <td><%=sdf.format(bean4.getTrx_date().getTime()) %></td>
                <td><%=bean4.getVtype()%></td>
        ...
        %>
            <tr>
                ...
                <td><%=sdf.format(lbean4.getTrx_date()) %></td>
                <td><%=lbean4.getVtype() %></td>
        ...
        %>
            <tr>
                ...
                <td><%=sdf.format(lbean5.getTrx_date()) %></td>
                <td><%=lbean5.getVtype() %></td>
