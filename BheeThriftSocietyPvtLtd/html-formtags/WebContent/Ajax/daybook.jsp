...
<center>
DayBook  as on Date From <%=new SimpleDateFormat("dd-MM-yyyy").format(from) %>&nbsp; To  &nbsp; <%=new SimpleDateFormat("dd-MM-yyyy").format(to) %>
</center>
</td>
</tr>
<td>
<table id="day_book" name="day_book" border="1" cellpadding="0" cellspacing="0" width="100%" style="border:0px solid black;background-image:url(images/tab_background.png); margin-top:0px;margin-bottom:0px; font-family:'Times New Roman', Times, serif;" align="center">
...
ArrayList<TransactionBean> vtb=vtd.getAllTransactionByDate(from,to);
...
%>
			...
			<td ><%=b.getVoucher().getVno().toString() %></td>
			<td ><%=b.getVoucher().getDescription() %></td>
			<% 
